...
(define (collect/alloc-tuple len num-bytes alloc-label type mapping)
  (Let '_ (If (Prim '< (list (Prim '+ (list (GlobalValue 'free_ptr)
                                            (Int num-bytes)))
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; remove-complex-opera* : Lalloc -> Lalloc^mon
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(define (atom? e) (match e [(Int i) #t] [(Var v) #t] [(Bool b) #t] [(Void) #t] [else #f]))
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; explicate-control : Lalloc^mon -> Calloc
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; select-instructions : Calloc -> x86alloc
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(define (select-atm e)
  (match e
    [(Var x) (Var x)]
  ...
  (match e
    ...
    [(Prim 'vector-length (list tup))
     (list (Instr 'movq (list (select-atm tup) (Reg 'r11)))
           ...
           (Instr 'andq (list (Imm 126) x)) ;; 0b1111110
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; constant-propogation : x86alloc -> x86alloc
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; uncover-live : x86alloc -> x86alloc
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(define (uncover-live p)
  (match-let [((X86Program info bls) p)]
    ...
    (define df-analysis (analyze_dataflow (transpose (dict-ref info 'cf-graph)) (analyze-dataflow-transfer bls-block) (set) set-union))
    (X86Program info (unbox bls-block))))

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; eliminate-movqs : x86alloc -> x86alloc
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; build-interference : x86alloc -> x86alloc
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; allocate-registers : x86alloc -> x86alloc
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; patch-instructions : x86alloc -> x86alloc
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; kill-unused-blocks : x86alloc -> x86alloc
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; prelude-and-conclusion : x86alloc -> x86alloc
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(define (prelude-and-conclusion p)
  (match-let [((X86Program info bls) p)]
    ...
    (define main  (flatten (list
                            ...
                            (Instr 'addq (list (Imm (* 8 (add1 root-spilled))) (Reg 'r15)))
                            (Jmp 'start))))
    (define concl (flatten (list
                            (Instr 'subq (list (Imm (* 8 (add1 root-spilled))) (Reg 'r15)))
...
(define compiler-passes
  `(
    ...
    ("uniquify" ,uniquify ,interp-Lvec ,type-check-Lvec-has-type)
